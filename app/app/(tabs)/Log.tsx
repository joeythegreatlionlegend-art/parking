...
const renderTableHeading=()=>{
    return (
        <View className="flex-1 flex-row gap-2 w-full h-auto py-2 items-center bg-slate-400 rounded-t-lg">
            <Text className="w-22 text-center text-white text-xs mx-1 pl-3 ">Date</Text>
            <Text className="w-20 text-center text-white text-xs mx-1 pl-5">ID</Text>
            <Text className="flex-1 text-center text-white text-xs mx-1 pl-3">Temp</Text>
            <Text className="flex-1 text-center text-white text-xs mx-1">Hum</Text>
            <Text className="flex-1 text-center text-white text-xs mx-1">Wtr Lvl 1</Text>
            <Text className="flex-1 text-center text-white text-xs mx-1">Wtr Lvl 2</Text>
            <Text className="flex-1 text-center text-white text-xs mx-1 pr-2">Wtr Lvl 3</Text>
        </View>
    );
}
...
const renderTableData=({item})=>{
    ...
    return (
        <View className="flex-1 flex-row gap-2 w-full h-auto py-2 items-center">
            <Text className="w-22 text-left text-xs mx-1 pl-2">{new Date(item.eventDate).toLocaleDateString()}</Text>
            <Text className="w-20 text-left text-xs mx-1">{item.device.deviceID}</Text>
            ...
            <Text className="flex-1 text-left text-xs mx-1 pr-2">{item.waterLevel1}</Text>
        </View>
    );
}
